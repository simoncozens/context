    ...
    function bidiFactory() {
        var bidi = (function (exports) {
                ...
                encodedString.split(',').forEach(function visit(entry) {
                    if (entry.indexOf('+') !== -1) {
                        ...
                        a = String.fromCodePoint(
                            (lastCode += parseInt(a, radix))
                        );
                        b = String.fromCodePoint(
                            (lastCode += parseInt(b, radix))
                        );
                        map.set(a, b);
            ...
            function getEmbeddingLevels(string, baseDirection) {
                ...
                for (var paraIdx = 0; paraIdx < paragraphs.length; paraIdx++) {
                    ...
                    for (
                        ...
                        charTypeCounts.set(
                            charType,
                            (charTypeCounts.get(charType) || 0) + 1
                        );
                        if (charType & NEUTRAL_ISOLATE_TYPES) {
                            charTypeCounts.set(
                                NEUTRAL_ISOLATE_TYPES,
                                (charTypeCounts.get(NEUTRAL_ISOLATE_TYPES) ||
                                    0) + 1
                            );
                        }
                        ...
                        if (charType & FORMATTING_TYPES) {
                            ...
                            if (charType & (TYPE_RLE | TYPE_LRE)) {
                                ...
                                var level = (
                                    charType === TYPE_RLE ? nextOdd : nextEven
                                )(stackTop._level);
                                if (
                                    level <= MAX_DEPTH &&
                            ...
                            // Explicit Overrides: 3.3.2 X4 - X5
                                ...
                                embedLevels[i$2] = stackTop._level; // 5.2
                                var level$1 = (
                                    charType === TYPE_RLO ? nextOdd : nextEven
                                )(stackTop._level);
                                if (
                                    level$1 <= MAX_DEPTH &&
                                    !overflowIsolateCount &&
                            ...
                            // Terminating Isolates: 3.3.2 X6a
                                ...
                                if (overflowIsolateCount > 0) {
                                    ...
                                    overflowEmbeddingCount = 0;
                                    while (
                                        !statusStack[statusStack.length - 1]
                                            ._isolate
                                    ) {
                                        statusStack.pop();
                                    }
                    ...
                    for (var runIdx = 0; runIdx < levelRuns.length; runIdx++) {
                        ...
                        if (
                            ...
                            for (
                                ...
                                (pdiIndex = isolationPairs.get(
                                    currentRun._end
                                )) != null;
                            ) {
                                for (
                                    var i$4 = runIdx + 1;
                                    i$4 < levelRuns.length;
                                    i$4++
                                ) {
                                    if (levelRuns[i$4]._start === pdiIndex) {
                                        seqRuns.push(
                                            (currentRun = levelRuns[i$4])
                                        );
                                        break;
                                    }
                                }
                            ...
                            isolatingRunSeqs.push({
                                ...
                                _sosType:
                                    Math.max(prevLevel, firstLevel) % 2
                                        ? TYPE_R
                                        : TYPE_L,
                                _eosType:
                                    Math.max(nextLevel, lastLevel) % 2
                                        ? TYPE_R
                                        : TYPE_L
                            });
                        }
                    ...
                    for (
                        var seqIdx = 0;
                        seqIdx < isolatingRunSeqs.length;
                        seqIdx++
                    ) {
                         ...
                         */
                        var embedDirection =
                            embedLevels[seqIndices$1[0]] & 1 ? TYPE_R : TYPE_L;
                        ...
                        if (
                            ...
                            for (
                                var si$5 = 0;
                                si$5 < seqIndices$1.length;
                                si$5++
                            ) {
                                var i$13 = seqIndices$1[si$5];
                                if (
                                    charTypes[i$13] &
                                    (TYPE_ET | TYPE_ES | TYPE_CS)
                                ) {
                        ...
                        if (charTypeCounts.get(NEUTRAL_ISOLATE_TYPES)) {
                            ...
                            var R_TYPES_FOR_N_STEPS =
                                TYPE_R | TYPE_EN | TYPE_AN;
                            var STRONG_TYPES_FOR_N_STEPS =
                                R_TYPES_FOR_N_STEPS | TYPE_L;
                                        ...
                                        // Closing bracket
                                            ...
                                            for (
                                                ...
                                                if (
                                                    ...
                                                    bracketPairs.push([
                                                        openerStack[stackIdx]
                                                            .seqIndex,
                                                        si$7
                                                    ]);
                                                    openerStack.length =
                                                        stackIdx; //pop the matching bracket and all following
                                                    break;
                                                }
                                            }
                                        }
                            ...
                            for (
                                ...
                                if (useStrongType) {
                                    ...
                                    if (useStrongType !== embedDirection) {
                                        for (
                                            var si$10 = openSeqIdx + 1;
                                            si$10 < seqIndices$1.length;
                                            si$10++
                                        ) {
                                            if (
                                                !(
                            ...
                            for (
                                var si$12 = 0;
                                si$12 < seqIndices$1.length;
                                si$12++
                            ) {
                                if (
                                    charTypes[seqIndices$1[si$12]] &
                                    NEUTRAL_ISOLATE_TYPES
                                ) {
                    ...
                    for (
                        ...
                        if (
                            i$17 === paragraph.end ||
                            getBidiCharType(string[i$17]) & (TYPE_S | TYPE_B)
                        ) {
                            for (
                                var j$1 = i$17;
                                j$1 >= 0 &&
                                getBidiCharType(string[j$1]) & TRAILING_TYPES;
                                j$1--
                            ) {
                ...
                function determineAutoEmbedLevel(start, isFSI) {
                    ...
                    for (var i = start; i < string.length; i++) {
                        ...
                        if (
                            charType & (TYPE_B | TYPE_L) ||
                            (isFSI && charType === TYPE_PDI)
                        ) {
                            return 0;
                        }
            ...
            function getReorderSegments(
                ...
                embeddingLevelsResult.paragraphs.forEach(function (paragraph) {
                    ...
                    if (lineStart < lineEnd) {
                        ...
                        var lineLevels = embeddingLevelsResult.levels.slice(
                            lineStart,
                            lineEnd + 1
                        );
                        ...
                        for (
                            var i = lineEnd;
                            i >= lineStart &&
                            getBidiCharType(string[i]) & TRAILING_TYPES;
                            i--
                        ) {
                        ...
                        for (var lvl = maxLevel; lvl >= minOddLevel; lvl--) {
                            for (var i$2 = 0; i$2 < lineLevels.length; i$2++) {
                                if (lineLevels[i$2] >= lvl) {
                                    var segStart = i$2;
                                    while (
                                        i$2 + 1 < lineLevels.length &&
                                        lineLevels[i$2 + 1] >= lvl
                                    ) {
                                        i$2++;
                                    }
                                    if (i$2 > segStart) {
            ...
            function getReorderedString(string, embedLevelsResult, start, end) {
                var indices = getReorderedIndices(
                    string,
                    embedLevelsResult,
                    start,
                    end
            ...
            function getReorderedIndices(
                ...
                var segments = getReorderSegments(
                    string,
                    embedLevelsResult,
                    start,
                    end
